...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="wealthtax.html">Wealth Tax</a>
      
      <a href="watertax.html">Water Tax</a>
      
      <a href="housetax.html">House Tax</a>
    </div>
  </div> 
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="phone.html">Phone Bill</a>
...
<a href="trans.html">Transcations</a>
...
$srvno = $_SESSION['srvno'];

$uname="UPDATE electricity SET status='Paid' WHERE serviceno='$srvno'";
...
<br/><br/><br/>
<center>
<big> Bill Payment has been DONE!!!!!!</big>
