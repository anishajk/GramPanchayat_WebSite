...
<br><br>
<big><b><center><u>WATER TAX</u></center></b></big>
<br><br><br>
<?php
...
$dt = "UPDATE watertax SET paydate=CURRENT_DATE() WHERE hsc= '".$_POST['hsc']."' ";

$show = "SELECT * FROM watertax where hsc= '".$_POST['hsc']."' and sno<=5 ";
...
echo <<<_END
  ...
  <a href="wrPAYMENT.php"><input type="button" value="PAY NOW" /></a>
