...
<center>
<form onSubmit="required()" action="TRANSview.php" method="post">
<table>
<tr>
<td>
Aadhar Number:<br/><br/>
...
<td>
<input type="text" placeholder="aadharno" name='aadharno' required><br/><br/>
</td>
</tr>
<tr>
<td>
...
<option>   </option>
<option value="WealthTax">Wealth Tax</option>
<option value="WaterTax">Water Tax</option>
<option value="HouseTax">House Tax</option>
