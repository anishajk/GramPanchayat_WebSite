...
<br><br>
<big><b><center><u>PHONE BILL</u></center></b></big>
<br><br><br>
<?php
...
$dt = "UPDATE phonebill SET paydate=CURRENT_DATE() WHERE phoneno= '".$_POST['phoneno']."' ";

$show = "SELECT * FROM phonebill where phoneno= '".$_POST['phoneno']."' and sno<=5 ";
...
echo <<<_END
  ...
  <a href="phPAYMENT.php"><input type="button" value="PAY NOW" /></a>
