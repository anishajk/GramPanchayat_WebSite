...
<br><br>
<big><b><center><u>ELECTRICITY BILL</u></center></b></big>/
<br><br><br>
<?php
...
$dt = "UPDATE electricity SET paydate=CURRENT_DATE() WHERE serviceno= '".$_POST['serviceno']."' ";
$show = "SELECT * FROM electricity where serviceno= '".$_POST['serviceno']."' and sno<=5 ";
...
echo <<<_END
  ...
  <a href="elPAYMENT.php"><input type="button" value="PAY NOW" /></a>
