...
<br><br>
<center>
<big><b><u>WEALTH TAX</u></b></big></center>
<br><br><br>
<?php
...
$dt = "UPDATE wealthtax SET paydate=CURRENT_DATE() WHERE  assessmentno = '".$_POST['assessmentno']."'  ";

$show = "SELECT * FROM wealthtax where assessmentno = '".$_POST['assessmentno']."' and sno<=5 ";
...
echo <<<_END
  ...
  <a href="wltPAYMENT.php"><input type="button" value="PAY NOW" /></a>
  </center>
...
else
{
 ...
 <script type="text/javascript">
 alert("Invalid Assessment Number!!!!");
 </script>
